...
namespace DC4._0Backend.Controllers
{
    ...
    namespace DC4._0Backend.Controllers
    {
        public class EliteExportPayrollController : ApiController
        {
            ...
            public string SearchPayrollRecord([FromBody]AgencyPayrollExport payroll)
            {
                ...
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("dbo.spPayrollCalc_CSL", sqlConnection);
            ...
            public string GeneratePayrollFile([FromBody] AgencyPayrollExport export)
            {
                ...
                " AND ui.EmployeeCategory in ('Permanent','Casual') " +
                  " And ui.Agency In ('','CSL')";

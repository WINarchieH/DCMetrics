...
class ApexChart extends React.Component {
    constructor(props) {
      ...
      manager_radialseries: [
        ...
        Role_radialoptions: {
          ...
          title:
          {
            text:"Total Moves Per Role Per Day",
            align:"left",
          style: {
            fontSize:  '12px',
            fontFamily: "Montserrat",
        ...
        shift_radialoptions: {
          ...
          title:
          {
            text:"Total Moves Per Shift Per Day",
            align:"left",
          style: {
            fontSize:  '12px',
            fontFamily: "Montserrat",
        ...
        Role_options:{
          ...
          title:{
            text:"Moves Productivity By Role",
            align:"center",
      ...
      shift_options:{
        ...
        title:{
          text:"Move Productivity By Shift",
          align:"center",
       ...
       manager_radialoptions: {
           ...
           title:
            {
              text:"Total Moves Per Manager Per Day",
              align:"left",
           style: {
             fontSize:  '12px',
             fontFamily: "Montserrat",
      ...
      manager_options:{
        ...
        title:{
          text:"Move Productivity By Manager",
          align:"center",
      ...
      handleEndDateChange = (e) =>
    {
      ...
      onButtonClick=(e)=>
      {
        ...
        api.post('/Dashboard/DashboardProductivity/GetCCA_MoveProd_Split',body).then(
          res => 
          {
           ...
           // Move Per User
           api.post('/Dashboard/DashboardProductivity/GetMove_PerUser',body).then(
            res => 

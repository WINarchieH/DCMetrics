...
class ApexChart extends React.Component {
    constructor(props) {
      ...
      manager_radialseries: [
        ...
        Role_radialoptions: {
          ...
          title:
          {
            text:"Total Putaways Per Role Per Day",
            align:"left",
          style: {
            fontSize:  '12px',
            fontFamily: "Montserrat",
        ...
        shift_radialoptions: {
          ...
          title:
          {
            text:"Total Putaways Per Shift Per Day",
            align:"left",
          style: {
            fontSize:  '12px',
            fontFamily: "Montserrat",
        ...
        Role_options:{
          ...
          title:{
            text:"Putaway Productiivity By Role",
            align:"center",
      ...
      shift_options:{
        ...
        title:{
          text:"Putaway Productiivity By Shift",
          align:"center",
       ...
       manager_radialoptions: {
           ...
           title:
            {
              text:"Total Putaways Per Manager Per Day",
              align:"left",
           style: {
             fontSize:  '12px',
             fontFamily: "Montserrat",
      ...
      manager_options:{
        ...
        title:{
          text:"Putaway Productiivity By Manager",
          align:"center",
      ...
      handleEndDateChange = (e) =>
    {
      ...
      onButtonClick=(e)=>
      {
        ...
        api.post('/Dashboard/DashboardProductivity/GetCCA_PutawayProd_Split',body).then(
          res => 
          {
            ...
            var pickersunitsPerHour =[];
             ...
             // putaway Per User
             api.post('/Dashboard/DashboardProductivity/GetPutaway_PerUser',body).then(
              res => 

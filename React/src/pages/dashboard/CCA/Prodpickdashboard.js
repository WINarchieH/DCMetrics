...
class ApexChart extends React.Component {
    constructor(props) {
      ...
      manager_radialseries: [
        ...
        Role_radialoptions: {
          ...
          title:
          {
            text:"Total Pick Per Role Per Day",
            align:"left",
          style: {
            fontSize:  '12px',
            fontFamily: "Montserrat",
        ...
        shift_radialoptions: {
          ...
          title:
          {
            text:"Total Pick Per Shift Per Day",
            align:"left",
          style: {
            fontSize:  '12px',
            fontFamily: "Montserrat",
        ...
        Role_options:{
          ...
          title:{
            text:"Pick Productivity By Role",
            align:"center",
      ...
      shift_options:{
        ...
        title:{
          text:"Pick Productivity By Shift",
          align:"center",
       ...
       manager_radialoptions: {
           ...
           title:
            {
              text:"Total Pick Per Manager Per Day",
              align:"left",
           style: {
             fontSize:  '12px',
             fontFamily: "Montserrat",
      ...
      manager_options:{
        ...
        title:{
          text:"Pick Productivity By Manager",
          align:"center",
      ...
      handleEndDateChange = (e) =>
    {
      ...
      onButtonClick=(e)=>
      {
        ...
        api.post('/Dashboard/DashboardProductivity/GetCCA_PickProd_Split',body).then(
          res => 
          {
          ...
          // Reps Per User
             ...
             api.post('/Dashboard/DashboardProductivity/GetPick_PerUser',body).then(
              res => 

...
class PickProd extends React.Component {
                   ...
                   stroke: {
                     ...
                     colors: ['transparent']
                      ...
                      xaxis: {
                       ...
                       title:
                       {
                         text:'Pick Rate By Pickers Trainee - Afternoon Shift',
                         style:
                         {
                            fontSize: '12px',
                          fontFamily: "Montserrat",
    ...
    async componentDidMount() {
        ...
        let body = new URLSearchParams({
         ...
         api.post('/Dashboard/CCAPickDashboard/GetCCA_PickRates_User_AfternoonShift_Trainee', body).then( // Reasons Codes List 
          res => {

...
class PickProd extends React.Component {
    ...
    async componentDidMount() {
        ...
        let body = new URLSearchParams({
         ...
         api.post('/Dashboard/CCAPickDashboard/GetCCA_Reworks_Daily', body).then( // Reasons Codes List 
          res => {
            ...
            let resdata = res.data;
               ...
               var temp =   resdata.dates_Shift;
                   ...
                   temp =   resdata.Reworks_Day_Daily;
                   var reworks_DayShift = temp.map(x=>x);
     
                   
                  temp =   resdata.Reworks_afternoon_Daily;

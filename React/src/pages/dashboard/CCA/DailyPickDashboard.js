...
import Pickproductivity from './graphtabs/pickProductivity_Exp';
import Pickproductivitytrainee from './graphtabs/pickProductivity_Trainee';
import PickProdDC from './graphtabs/pickProductivity_DC';
import PickcasesDC from './graphtabs/pickCases_DC';
import PickcasesTrainee from './graphtabs/pickcases_Trainee';
import PickCasesExp from './graphtabs/pickCases_Exp';
import PickCasesAll from './graphtabs/pickCases_All';
...
import ReworkDaily from './graphtabs/reworkDaily';
...
const  UserHistory = () => {
   ...
   var lastSunday = new Date(beforeOneWeek2.setDate(diffToMonday + 6));
    ...
    return (
        <Screen>
              <h2 style={{ fontFamily:'Montserrat',color:'rgb(35,168,224)' }} >Daily Pick Dashboard</h2>

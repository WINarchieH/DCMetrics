...
class MoveProd extends React.Component {
    constructor(props) {
        super(props);
                   ...
                   stroke: {
                     ...
                     colors: ['transparent']
                      ...
                      xaxis: {
                       ...
                       title:
                       {
                         text:'Total Moves Per User - Afternoon Shift',
                         style:
                         {
                            fontSize: '12px',
                          fontFamily: "Montserrat",
    ...
    async componentDidMount() {
        ...
        let body = new URLSearchParams({
         ...
         api.post('/Dashboard/TMADashboard/GetMoves_PerUser_AfternoonShift', body).then( // Reasons Codes List 
          res => {

...
import MoveGraph from './move_user_DayShift';
import MoveGraphAfternoonShift from './move_user_AfternoonShift';
...
const  UserHistory = () => {
   ...
   var lastSunday = new Date(beforeOneWeek2.setDate(diffToMonday + 6));
    ...
    return (
        <Screen>
              <h2 style={{ fontFamily:'Montserrat',color:'rgb(35,168,224)' }} >Daily Move Dashboard</h2>
            <div className={classesGrid.root}>
                <Grid container spacing={1}>
                    ...
                    <Card className={classesCards.root} style={{ backgroundColor: 'rgb(241,242,242)'  }}>
                       ...
                       <MoveGraph
                        startDate ={fromDate}
                        endDate={toDate}  loadGraphs={loadGraphs}   >

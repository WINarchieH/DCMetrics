...
const TimesheetTable = () => {
    ...
    const tableColumns = [
        ...
        { Header: 'Employee Name', accessor: 'FullName', Filter: SelectMultipleFilter, filter: 'contains', modalType: 'dropdown' },        
        ...
        { Header: 'Base Hourly', accessor: 'BaseHourly', modalType: 'textbox'},
        { Header: 'Overtime(1.4x)', accessor: 'Overtime_1_4x', modalType: 'textbox'},
        { Header: 'Overtime(1.8x)', accessor: 'Overtime_1_8x', modalType: 'textbox' },
        { Header: 'Total Hours', accessor: 'TotalHours', modalType: 'textbox' },
        { Header: 'Allow OT At Start', accessor: 'AllowOTAtStart', modalType: 'textbox'},
        { Header: 'Allow OT At End', accessor: 'AllowOTAtEnd', modalType: 'textbox'},
    ...
    const getTable = async (fromDate, toDate) => { // TODO: API Request for table
        ...
        await api.post('/Report/TimeSheet/GetTimesheetReport_BRI', body).then(
            res => {
                let data = res.data;
            ...
            var rowdata = 
             {
              ...
              totalhrs =   parseInt(totalhrs) + parseInt(rowtotalhrs);
              totalsingletime =   parseInt(totalsingletime) + parseInt(rowsingletime);
              totaltimeandhalf =  parseInt(totaltimeandhalf) + parseInt(rowtimeandhalf);
              totaldoubletime =  parseInt(totaldoubletime) + parseInt(rowdoubletime);
    ...
    const OpenReportPrintTab = () => {
            history.push('/Report/BRIimesheetPrint');
            // if (win) {

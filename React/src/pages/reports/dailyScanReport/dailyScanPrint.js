...
import './dailyScan.scss';
import Card from '@material-ui/core/Card';
import Typography from '@material-ui/core/Typography';
import { makeStyles } from '@material-ui/core/styles';
import { CardContent } from '@material-ui/core';

const DailyScanReportPrint = () => {
  ...
  useEffect(() => {
    let URL = ssrs + '%2fReports%2f'+site+'%2fDaily+Clock+Scans+Report&rs:embed=true';
      ...
      <div className='report-container'>
        <Card className={classes.root}>
          <CardContent className={classes.content}> 
           ...
           Indirect Activity Report
            </Typography>
            <iframe className={classes.IFrame}
                    title="Daily Clock Scan Report"
                    src={url}/>
          </CardContent>
        </Card>
      </div>
...
export default DailyScanReportPrint;
...
const tableTitle = 'Productivity Load Report';
...
const ProductivityPickReport = () => {
    ...
    const tableColumns = [
        ...
        { Header: 'Units Per hour', accessor: 'Units_Hr', modalType: 'textbox' },
    ...
    const getTable = async (fromDate, toDate) => { // TODO: API Request for table
        ...
        await api.post('/Report/Productivity/GetProductivityLoadReport', body).then(
            res => {
                let data = res.data;
    ...
    const userSummaryTableColumns = [
        ...
        { Header: 'Lines', accessor: 'NoOfMove' },
    ...
    const OpenReportPrintTab = () => {
            ...
            history.push('/Report/ProductivityLoadPrint');
            // if (win) {

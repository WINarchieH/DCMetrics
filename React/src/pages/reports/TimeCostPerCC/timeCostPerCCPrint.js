...
const TimeCostPerCCPrint = () => {
  ...
  useEffect(() => {
    ...
    let URL = ssrs + '%2fReports%2f'+site+'%2fTimeCostPerCC&rs:embed=true';
    setUrl(URL);
  }, [site]);
      ...
      <div className='report-container'>
        <Card className={classes.root}>
          <CardContent className={classes.content}> 
            ...
            Time Cost Per Cost Centre Report
            </Typography>
            <iframe className={classes.IFrame}
                    title="Time Cost Per Cost Centre Report"
                    src={url}/>
          </CardContent>
        </Card>
      </div>
...
export default TimeCostPerCCPrint;
...
import './timebetweenorders.scss';
import Card from '@material-ui/core/Card';
import Typography from '@material-ui/core/Typography';
import { makeStyles } from '@material-ui/core/styles';
import { CardContent } from '@material-ui/core';

const TimeBetweenOrdersReportPrint = () => {
  ...
  useEffect(() => {
    let URL = ssrs + '%2fReports%2f'+site+'%2fTimeBetweenOrders&rs:embed=true';
    setUrl(URL);
  }, [site]);
        ...
        <Card className={classes.root}>
          <CardContent className={classes.content}>
            ...
            <iframe className={classes.IFrame}
                    title="Time Between Orders Report"
                    src={url}/>
          </CardContent>
        </Card>
      </div>
...
export default TimeBetweenOrdersReportPrint;
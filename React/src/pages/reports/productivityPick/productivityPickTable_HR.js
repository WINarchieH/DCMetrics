...
const tableTitle = 'Productivity Pick High Raise Report';

const ProductivityPickHRReport = () => {
    ...
    const getTable = async (fromDate, toDate) => { // TODO: API Request for table
        ...
        await api.post('/Report/ProductivityPick/GetProductivityReport_HR', body).then(
            res => {
                let data = res.data;
    ...
    const OpenReportPrintTab = () => {
            ...
            history.push('/Report/ProductivityPickPrint_HR');
            // if (win) {
...
export default ProductivityPickHRReport;

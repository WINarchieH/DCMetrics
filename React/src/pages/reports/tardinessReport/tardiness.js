...
const tableTitle = 'Tardiness Report';
...
const Tardiness = () => {
    ...
    const tableColumns = [
        { Header: 'User ID', accessor: 'UserID', Filter: SelectMultipleFilter, filter: 'contains', modalType: 'dropdown',FilterValue: employeeID, SetFilterValue: setemployeeID },
        ...
        { Header: 'Scan Type', accessor: 'ScanType', Filter: SelectMultipleFilter, filter: 'contains', modalType: 'dropdown'  },
    ...
    const getTable = async (fromDate, toDate) => { // TODO: API Request for table
        ...
        await api.post('/Report/TardinessReport/GetReport', body).then(
            res => {
                let data = res.data;
    ...
    const OpenReportPrintTab = () => {
        ...
        history.push('/Report/TardinessReportPrint');
        // if (win) {

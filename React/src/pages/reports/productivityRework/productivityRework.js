...
const tableTitle = 'Productivity Rework Report';
...
const Rework = () => {
    ...
    const tableColumns = [
        ...
        { Header: 'Tools Built', accessor: 'ToolsBuilt', modalType: 'textbox' },
        { Header: 'Components Put Together', accessor: 'ComponentsPutTogether', modalType: 'textbox' },
        { Header: 'Tools Built Per Hr', accessor: 'ToolsBuiltPerHr', modalType: 'textbox' },
        { Header: 'Components Put Together Per Hr', accessor: 'ComponentsPutTogetherPerHr', modalType: 'textbox' }
    ...
    const getTable = async (fromDate, toDate) => { // TODO: API Request for table
        ...
        await api.post('/Report/ProductivityReport/GetReworkReport', body).then(
            res => {
                let data = res.data;
    ...
    const OpenReportPrintTab = () => {
        ...
        history.push('/Report/ProductivityReworkPrint');
        // if (win) {
